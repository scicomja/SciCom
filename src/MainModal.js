...
class MainModal extends React.Component {
	...
	questionCard({ question, index, values, setFieldValue, editing = false }) {
		return (
				...
				{editing && (
					<CardBody style={style.questionInputContainer}>
						...
						<div style={style.addQuestionButtonGroup}>
							<Button
								disabled={!this.state.editingQuestion.length}
								style={{
					...
					<Formik
						...
						validationSchema={Yup.object().shape({
							...
							from: Yup.date()
								.min(
									moment().startOf("day"),
									"Project cannot start from the past"
								)
								.required(),
							...
							<Form>
								...
								<Label id="question-label">
									...
									<Tooltip
										...
										Fill in the questsion you would like the applicants to
										answer before they submit applications to this project. You
										cannot modify the questions of projects once they are
										created.
									</Tooltip>
								</Label>
								<Col>
